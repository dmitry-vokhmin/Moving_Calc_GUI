...
class AssetTypePageUi:
    ...
    def set_update_asset(self, asset_data, update_funk, delete_funk):
        ...
        self.main_modal_window.ui.length_input.setText(str(asset_data["length"]) or "")
        self.main_modal_window.ui.width_input.setText(str(asset_data["width"]) or "")
        self.main_modal_window.ui.height_input.setText(str(asset_data["height"]) or "")
