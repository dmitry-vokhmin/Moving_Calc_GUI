...
class InventoryPageUi:
    ...
    def change_page_selector_style(self, is_all_inventory):
        ...
        if is_all_inventory:
            self.first_butt_all_inv.click()
        else:
            self.first_butt_preset.click()

    def set_left_menu(self, frame, layout, funk, data, is_preset_menu):
        for idx, room in enumerate(data):
            ...
            if is_preset_menu:
                ...
                room_menu_butt.clicked.connect(funk(room["room_id"], room["id"], room_menu_butt))
                if idx == 0:
                    self.first_butt_all_inv = room_menu_butt
                self.main_window.ui.inventory_search_clear.setVisible(False)

    def set_category_menu(self, categories, funk, instance):
        self.main_window.delete_layout(self.main_window.ui.inventory_categor_butt_frame.layout())
        inventory_categor_butt_layout = FlowLayout(self.main_window.ui.inventory_categor_butt_frame)
        inventory_categor_butt_layout.setContentsMargins(0, 0, 0, 0)
        inventory_categor_butt_layout.setSpacing(5)
        button_all = QPushButton(self.main_window.ui.inventory_categor_butt_frame)
        ...
        for category in categories:
            button = QPushButton(self.main_window.ui.inventory_categor_butt_frame)
    ...
    def set_room_inventory_card(
        ...
        self.main_window.delete_layout(self.main_window.ui.inventory_content_clear_frame.layout())
        inventory_content_clear_layout = FlowLayout(self.main_window.ui.inventory_content_clear_frame)
    ...
    def set_room_card(self, inventory, layout, frame, add_funk, instance):
        ...
        add_item_butt.clicked.connect(add_funk(inventory["id"]))
    ...
    def set_custom_room_card(self, inventory, layout, frame, del_funk, add_funk, instance):
        ...
        add_butt.clicked.connect(add_funk(inventory["id"]))
    ...
    def categorize_inventory(self, category_id):
